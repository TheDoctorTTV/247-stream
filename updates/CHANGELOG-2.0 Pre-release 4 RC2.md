...
## Added
- New **Sources** tab in the web dashboard for managing multiple source URLs in one place.
...
- Dashboard source input UX has been reworked:
  - Replaced free-text source field on Stream tab with a dropdown selector.
